...
export default function IndexChoose() {
  return (
    ...
    <ul>
      <li>
        <div className="li_cont">
          <div className="li_tel">All-in-one Service</div>
      ...
      <li>
        <div className="li_cont">
          <div className="li_tel">Curated Design</div>
          <div className="li_text">
            <p>
      ...
      <li>
        <div className="li_cont">
          <div className="li_tel">Superior Quality</div>
          <div className="li_text">
            <p>
      ...
      <li>
        <div className="li_cont">
          <div className="li_tel">Reliable Assurance</div>
          <div className="li_text">
            <p>
