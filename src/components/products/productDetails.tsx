      ...
      <div className="row">
        <div className="col-xxl-6 col-xl-6 col-lg-5 col-12">
          <div className="product-img-tabs">
            <ul className="nav nav-tabs" id="myTab" role="tablist">
              <li className="nav-item" role="presentation">
                <button
                  ...
                  aria-selected="true"
                >
                  <img src="assets/img/shop/shop-sm-1.jpg" alt="theme-pure" />
                </button>
              </li>
              <li className="nav-item" role="presentation">
                <button
                  ...
                  aria-selected="false"
                >
                  <img src="assets/img/shop/shop-sm-2.jpg" alt="theme-pure" />
                </button>
              </li>
              <li className="nav-item" role="presentation">
                <button
                  ...
                  aria-selected="false"
                >
                  <img src="assets/img/shop/shop-sm-3.jpg" alt="theme-pure" />
                </button>
              </li>
            </ul>
            <div className="tab-content" id="myTabContent">
              ...
              >
                <img src="assets/img/shop/shop-big-1.jpg" alt="theme-pure" />
              </div>
              <div
              ...
              >
                <img src="assets/img/shop/shop-big-2.jpg" alt="theme-pure" />
              </div>
              <div
                className="tab-pane fade"
                id="contact"
              ...
              >
                <img src="assets/img/shop/shop-big-3.jpg" alt="theme-pure" />
              </div>
            </div>
          </div>
        </div>
        <div className="col-xxl-6 col-xl-6 col-lg-7 col-12">
          <div className="product-details-content">
            ...
            <h3 className="product-details-title mb-20">
              Wide Cotton Tunic extreme hammer
            </h3>
            ...
            <div className="product-quantity-wapper mb-40">
              <form>
                <input className="f-left mr-20" type="number" placeholder="Enter quantity" />
                <a
                  className="tp-btn product-quantity-button f-left mr-20"
                  href="shop-details#"
                >
            ...
            <div className="product-details-meta">
              ...
              <div className="categories mb-5">
                <span>Categories:</span> <a href="#">T-Shirts,</a>{" "}
                <a href="#">Tops,</a> <a href="#">Womens</a>
              </div>
              <div className="tag mb-25">
                <span>Tags:</span> <a href="#"> fashion,</a>{" "}
                <a href="#">t-shirts,</a> <a href="#"> women</a>
              </div>
            </div>
            ...
            <div className="tab-content tp-content-tab" id="myTabContent-2">
              ...
              >
                <p>
                  ...
                  goods. A service regarded to as a type of product. Commodities
                  are usually raw materials metals and agricultural products,
                  but a commodity can also be anything wide the open market. In
                  project management, the formal definition of the project
                  deliverables
                </p>
                <p>
                  A product can be classified as tangible or intangible. A
                  tangible product is a physical object that can be perceived by
                  touch building, vehicle, gadget, An intangible product is a
                  product that can only be perceived indirectly such as an
      ...
      <div className="row">
        <div className="col-xl-6">
          <div className="tp-section-box tp-section-box-2 p-relative mb-50">
            ...
            <h2 className="tp-section-title">Related Products</h2>
          </div>
        </div>
          ...
          <div className="slick-list">
            ...
            >
              <div
                ...
                aria-hidden="true"
                style={{ width: "3.5714285714285716%" }}
              >
                <div>
                  <div
                  ...
                  >
                    <div className="tp-porduct-item p-relative text-center mb-30">
                      <img src="assets/img/shop/shop-8.jpg" alt="theme-pure" />
                      <div className="tp-porduct-content">
                        ...
                        <div className="shop-cart">
                          <a className="tp-btn" href="cart">
                            <i className="fal fa-shopping-cart" /> {/* */}Add To
                            Cart
                          </a>
                        </div>
                      </div>
              ...
              >
                <div>
                  ...
                  >
                    <div className="tp-porduct-item p-relative text-center mb-30">
                      <img src="assets/img/shop/shop-9.jpg" alt="theme-pure" />
                      <div className="tp-porduct-content">
                        <div className="tp-pro-rating mb-5">
                          <span>
                            <i className="fas fa-star" />
              ...
              >
                <div>
                  ...
                  >
                    <div className="tp-porduct-item p-relative text-center mb-30">
                      <img src="assets/img/shop/shop-10.jpg" alt="theme-pure" />
                      <div className="tp-porduct-content">
                        <div className="tp-pro-rating mb-5">
                          <span>
                            <i className="fas fa-star" />
              ...
              >
                <div>
                  ...
                  >
                    <div className="tp-porduct-item p-relative text-center mb-30">
                      <img src="assets/img/shop/shop-12.jpg" alt="theme-pure" />
                      <div className="tp-porduct-content">
                        <div className="tp-pro-rating mb-5">
                          <span>
                            <i className="fas fa-star" />
              ...
              <div
                ...
                tabIndex={-1}
                aria-hidden="false"
                style={{ outline: "none", width: "3.5714285714285716%" }}
              >
                <div>
                  <div
                    className="col-xl-3 col-lg-6 col-md-6"
                  ...
                  >
                    <div className="tp-porduct-item p-relative text-center mb-30">
                      <img src="assets/img/shop/shop-1.jpg" alt="theme-pure" />
                      <div className="tp-porduct-content">
                        <div className="tp-pro-rating mb-5">
                          <span>
                            <i className="fas fa-star" />
              ...
              >
                <div>
                  ...
                  >
                    <div className="tp-porduct-item p-relative text-center mb-30">
                      <img src="assets/img/shop/shop-2.jpg" alt="theme-pure" />
                      <div className="tp-porduct-content">
                        <div className="tp-pro-rating mb-5">
                          <span>
                            <i className="fas fa-star" />
                        ...
                        <h5 className="tp-pro-title">
                          <a href="#">Fighter Technology Camera</a>
                        </h5>
                        <div className="tp-pro-price">
                          <span>${/* */}19.00</span>
                        </div>
              ...
              >
                <div>
                  ...
                  >
                    <div className="tp-porduct-item p-relative text-center mb-30">
                      <img src="assets/img/shop/shop-3.jpg" alt="theme-pure" />
                      <div className="tp-porduct-content">
                        <div className="tp-pro-rating mb-5">
                          <span>
                            <i className="fas fa-star" />
              ...
              >
                <div>
                  ...
                  >
                    <div className="tp-porduct-item p-relative text-center mb-30">
                      <img src="assets/img/shop/shop-5.jpg" alt="theme-pure" />
                      <div className="tp-porduct-content">
                        <div className="tp-pro-rating mb-5">
                          <span>
                            <i className="fas fa-star" />
              ...
              >
                <div>
                  ...
                  >
                    <div className="tp-porduct-item p-relative text-center mb-30">
                      <img src="assets/img/shop/shop-4.jpg" alt="theme-pure" />
                      <div className="tp-porduct-content">
                        <div className="tp-pro-rating mb-5">
                          <span>
                            <i className="fas fa-star" />
              ...
              >
                <div>
                  ...
                  >
                    <div className="tp-porduct-item p-relative text-center mb-30">
                      <img src="assets/img/shop/shop-6.jpg" alt="theme-pure" />
                      <div className="tp-porduct-content">
                        <div className="tp-pro-rating mb-5">
                          <span>
                            <i className="fas fa-star" />
              ...
              >
                <div>
                  ...
                  >
                    <div className="tp-porduct-item p-relative text-center mb-30">
                      <img src="assets/img/shop/shop-7.jpg" alt="theme-pure" />
                      <div className="tp-porduct-content">
                        <div className="tp-pro-rating mb-5">
                          <span>
                            <i className="fas fa-star" />
